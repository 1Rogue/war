...
public class LoadoutYmlMapper {
    ...
    /**
     * Deserializes loadouts from the configuration. Backwards compatibility:
     * returns new-style loadouts and still modifies the loadouts parameter.
     *
    ...
    /**
     * Deserialize a loadout from the configuration. Backwards compatibility:
     * returns new-style loadout and still modifies the loadout parameter.
     *
     * @param config A configuration section that contains loadouts
