...
public class ZoneLobby {
     ...
     *
     * @param warzone
     * @param wall On which wall of the warzone will the lobby be stuck to at
     * mid-weight
     */
    ...
    /**
     * Use this constructor with /setzonelobby <zonename>. Makes sure the lobby
     * is not sticking inside the zone.
     *
     * @param warzone
    ...
    /**
     * Convenience ctor when loading form disk. This figures out the middle wall
     * block of the lobby from the volume instead of the other way around.
     */
    ...
    /**
     * Changes the lobby's position. Orientation is determined from the player
     * location. Creates volume or resets. Saves new lobby blocks.
     *
    ...
    /**
     * Classic way of creating a lobby. Lobby position goes to middle of zone
     * wall. Creates volume or resets. Saves new lobby blocks.
     *
     * @param newWall
     */
