...
public class ZoneVolume extends Volume {
     ...
     * @param start Starting position for reset.
     * @param total Amount of blocks to reset.
    ...
    /**
     * Get total saved blocks for this warzone. This should only be called on
     * nimitz-format warzones.
     *
    ...
    @Override
    /**
     * Reset the blocks in this warzone at the speed defined in
     * WarConfig#RESETSPEED. The job will automatically spawn new instances of
     * itself to run every tick until it is done resetting all blocks.
     */
